describe("search", function () {
    ...
    it("should return all items with tag: 'tag1'", function () {
        ...
        var filterFn = (item) => item.tag == "tag1";
        var sortFn = (item1, item2) => item1.createdAt - item2.createdAt;
    ...
    it("should return correct items for single page", function () {
        ...
        { "id": 5, "name": "Marrilee", "content": "aliquet massa id lobortis convallis tortor risus dapibus augue vel accumsan tellus nisi eu", "tag": "tag1", "createdAt": "8/10/2019", "imageUrl": "http://dummyimage.com/142x116.png/ff4444/ffffff" }];
        var filterFn = (item) => item.tag == "tag1";
        var sortFn = (item1, item2) => item1.createdAt - item2.createdAt;
